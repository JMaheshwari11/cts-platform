"""CTS Platform - Message 41 (Phase 4: Final Polish)"""
...
# ════════════════════════════════════════════════════════════════════
# 1. Final polish CSS — the last layer
# ════════════════════════════════════════════════════════════════════
FILES[str(CLIENT_DIR / "src/styles/phase4-polish.css")] = '''/* ════════════════════════════════════════════════════════════════════
   Phase 4: Final Polish
   Typography, focus, transitions, textures, consistency
   ════════════════════════════════════════════════════════════════════ */

/* ──────────────────────────────────────────────────────────────
   Numeric typography — KPI values feel weighty + premium
   ────────────────────────────────────────────────────────────── */
.kpi-value,
.num,
.tabular {
...
/* Larger KPI values: slightly tighter letter-spacing for confidence */
.kpi-value {
  letter-spacing: -0.025em;
}

/* ──────────────────────────────────────────────────────────────
   FOCUS STATES — keyboard navigation gets the same care
   ────────────────────────────────────────────────────────────── */
...
textarea:focus-visible {
  ...
  transition: outline-offset var(--duration-instant) var(--ease-default);
}
...
/* Card focus (when KPI card is focused via keyboard) */
...
/* ──────────────────────────────────────────────────────────────
   PAGE TRANSITIONS — confident motion between tabs
   ────────────────────────────────────────────────────────────── */
.app-main > main > * {
  animation: pageSlideIn var(--duration-confident) var(--ease-confident);
}
...
/* ──────────────────────────────────────────────────────────────
   QUIET TEXTURE — subtle noise on dark backgrounds
   ────────────────────────────────────────────────────────────── */
.dark .app-main {
  position: relative;
}

.dark .app-main::before {
  content: "";
  position: fixed;
  inset: 0;
  pointer-events: none;
...
/* ──────────────────────────────────────────────────────────────
   CARD CONTENT — improved internal rhythm
   ────────────────────────────────────────────────────────────── */
.chart-card > h3.chart-title:first-child,
.chart-card > div:first-child:has(h3.chart-title) {
  margin-bottom: var(--space-4);
}

/* ──────────────────────────────────────────────────────────────
   LINKS — subtle but visible hover
   ────────────────────────────────────────────────────────────── */
a:not(.nav-item):not(.btn-primary):not(.btn-secondary) {
  color: var(--accent);
...
/* ──────────────────────────────────────────────────────────────
   BUTTONS — final polish for hover & active states
   ────────────────────────────────────────────────────────────── */
.btn-primary,
.btn-secondary {
  position: relative;
...
/* ──────────────────────────────────────────────────────────────
   FORM CONTROLS — refined selects, inputs
   ────────────────────────────────────────────────────────────── */
select.control,
input.control,
textarea.control {
...
/* Custom select arrow */
select.control {
  background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23A100FF'><path d='M4.427 6.427a.6.6 0 01.848 0L8 9.152l2.725-2.725a.6.6 0 01.848.848l-3.149 3.15a.6.6 0 01-.848 0L4.427 7.275a.6.6 0 010-.848z'/></svg>");
...
/* ──────────────────────────────────────────────────────────────
   SCROLL — when content scrolls inside a card
   ────────────────────────────────────────────────────────────── */
.chart-card .overflow-x-auto,
.chart-card .overflow-y-auto {
  scrollbar-width: thin;
  scrollbar-color: var(--border-strong) transparent;
}

/* ──────────────────────────────────────────────────────────────
   TABLE — final polish (consistent across pages)
   ────────────────────────────────────────────────────────────── */
.data-table th {
  white-space: nowrap;
  user-select: none;
...
.data-table tbody td[class*="text-right"] {
...
/* ──────────────────────────────────────────────────────────────
   SECTION HEADERS — page header spacing rhythm
   ────────────────────────────────────────────────────────────── */
.page-container > div:first-child:has(.page-title) {
  margin-bottom: var(--space-2);
}

/* Default subtle padding between grids and other sections */
.page-container .grid + .grid {
  margin-top: 0;
}

/* ──────────────────────────────────────────────────────────────
   NAV ITEMS — sidebar refinements
   ────────────────────────────────────────────────────────────── */
.nav-item {
  position: relative;
  font-weight: 500;
...
# ════════════════════════════════════════════════════════════════════
# 2. Polished SettingsPage — feels like a real settings page
# ════════════════════════════════════════════════════════════════════
FILES[str(CLIENT_DIR / "src/pages/SettingsPage.jsx")] = '''import { useSettingsStore } from "../store/useSettingsStore"
...
# ════════════════════════════════════════════════════════════════════
# 3. main.jsx — import the Phase 4 CSS
# ════════════════════════════════════════════════════════════════════
...
def main():
    print()
    print("=" * 64)
    print("  CTS Platform - Message 41: Phase 4 — Final Polish")
    print("=" * 64)
    created = 0
    ...
    print("  - Page transitions feel deliberate, not abrupt")
    print("  - Tab through any page (Tab key) → focus rings purple+offset")
    print("  - Numbers (KPIs, tables) have tabular figures — columns align")
    print("  - Buttons have a satisfying press animation")
    print("  - Dark mode: subtle dot texture, very quiet")
    print("  - Settings page: redesigned cards, toggle switches, gradient avatar")
    print("  - Select dropdowns: custom purple chevron")
    print()
    print("Refresh browser (Ctrl + Shift + R).")
    print("Phase 4 = the design upgrade is complete.")
