"""CTS Platform - Message 37 (Consolidation Context + Score Composition Panel)"""
...
# ════════════════════════════════════════════════════════════════════
# 1. ConsolidationPage — add context callout + score composition panel
# ════════════════════════════════════════════════════════════════════
FILES[str(CLIENT_DIR / "src/pages/ConsolidationPage.jsx")] = '''import {
...
def main():
    print()
    print("=" * 64)
    print("  CTS Platform - Message 37: Consolidation Context Panel")
    print("=" * 64)
    created = 0
    ...
    print("=" * 64)
    print()
    print("Frontend hot-reloads. No backend restart needed.")
    print("Refresh /consolidation page (Ctrl + Shift + R).")
